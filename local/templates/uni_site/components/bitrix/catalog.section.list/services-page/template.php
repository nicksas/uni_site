        ...
        <div class="<? echo $arCurView['LIST']; ?>"><?
            ...
            case 'LINE':
                foreach ($arResult['SECTIONS'] as &$arSection) {
                    ...
                    ?>
                    <div id="<? echo $this->GetEditAreaId($arSection['ID']); ?>" class="catalog-section-list-item">
            ...
            case 'TILE':
                ...
                <div class="row services-items">
                    ...
                    foreach ($arResult['SECTIONS'] as &$arSection) {
                        ...
                        ?>
                        <div class="col-12 col-sm-6 col-md-4 item" id="<? echo $this->GetEditAreaId($arSection['ID']); ?>"
                             class="<?= $listColumsClass ?> catalog-section-list-item">
                            <div class="catalog-section-list-tile-img-container">
                                ...
                                <? if ('Y' != $arParams['HIDE_SECTION_NAME']) {
                                    ?>
                                    <div class="item__descr-wrap">
                                        <div class="item__descr-container">
                                            <h3 class="item__title">
                                                <? echo $arSection['NAME']; ?>
                                            </h3>
                                            <div class="item__descr"><? echo $arSection['DESCRIPTION']; ?></div>
                                        </div>
                                    </div>
                                    <?
                                }
            ...
            ?>
            <div class="catalog-section-list-item" id="<?= $this->GetEditAreaId($arSection['ID']); ?>">
