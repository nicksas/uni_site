		...
		<div class="col">
			...
			<div class="row" id="<?=$itemIds['TAB_CONTAINERS_ID']?>">
				<div class="col">
					...
					{
						?>
                        <div class="product-item-detail-tab-content 123" data-entity="tab-container" data-value="comments" style="display: none;">
                            <?
                            ...
                            ?>
                        </div><div class="product-item-detail-tab-content 123" data-entity="tab-container" data-value="comments" style="display: none;">
                        <?
                        $componentCommentsParams = array(
                            'ELEMENT_ID' => $arResult['ID'],
                            'ELEMENT_CODE' => '',
