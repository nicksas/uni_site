	...
	<div class="col">
		...
		<div class="row">
			<?foreach($arResult["ITEMS"] as $arItem):?>
				...
				?>
				<div class="news-list-item mb-2 col-sm-4" id="<?=$this->GetEditAreaId($arItem['ID']);?>">
					<div class="card">
						<?if($arParams["DISPLAY_PICTURE"]!="N"):?>
							...
							else if (is_array($arItem["PREVIEW_PICTURE"]))
							{
								...
								{
									?>
									<a class="item-link" href="<?= $arItem["DETAIL_PAGE_URL"] ?>">
										<img
											class="card-img-top"
						...
						<div class="card-body">
							...
							<?endif;?>
                                ...
                                $date_pub = CIBlockFormatProperties::DateFormat($arParams["DATE_CREATE"], MakeTimeStamp($arElement["DATE_CREATE"], CSite::GetDateFormat()));
                                ?>

                                <time class="pub-date" datetime="<? echo $date_pub ?>"><? echo $date_pub ?></time>
