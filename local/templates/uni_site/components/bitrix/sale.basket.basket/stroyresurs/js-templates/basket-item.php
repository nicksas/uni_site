				...
				<div class="basket-items-list-item-descriptions-inner" id="basket-item-height-aligner-{{ID}}">
					...
					if (in_array('PREVIEW_PICTURE', $arParams['COLUMNS_LIST']))
					{
						...
						<div class="basket-item-block-image<?=(!isset($mobileColumns['PREVIEW_PICTURE']) ? ' d-none d-sm-block' : '')?>">
							{{#DETAIL_PAGE_URL}}
								<a href="../../../../../../../../bitrix/virtual_file_system.php" class="basket-item-image-link">
							{{/DETAIL_PAGE_URL}}
					...
					<div class="basket-item-block-info">
						...
						<h2 class="basket-item-info-name">
							{{#DETAIL_PAGE_URL}}
								<a href="../../../../../../../../bitrix/virtual_file_system.php" class="basket-item-info-name-link">
							{{/DETAIL_PAGE_URL}}
															...
															{{#VALUE}}
																<span>
																	<img class="basket-item-custom-block-photo-item"
                                                                         src="../../../../../../../../bitrix/virtual_file_system.php" data-image-index="{{INDEX}}"
